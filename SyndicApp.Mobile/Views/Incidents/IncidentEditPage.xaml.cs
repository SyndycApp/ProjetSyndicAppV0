...
namespace SyndicApp.Mobile.Views.Incidents
{
    public partial class IncidentEditPage : ContentPage
    {
        ...
        public IncidentEditPage(IncidentEditViewModel vm, IAccountApi accountApi)
        {
            InitializeComponent();
            BindingContext = vm;
        ...
        protected override async void OnAppearing()
        {
            ...
            if (BindingContext is IncidentEditViewModel vm)
            {
                await vm.LoadAsync();
            }
        ...
        private async Task ApplyRoleRestrictionsAsync()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Erreur rôles IncidentEditPage : {ex}");
            }
        }
    }
}
