...
namespace SyndicApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260104135349_AddMajInTablePVv")]
    partial class AddMajInTablePVv
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ConvocationDestinataire", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConvocationDestinataires");
                });

            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ConvocationEnvoiLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConvocationEnvoiLogs");
                });

            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ConvocationPieceJointe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ConvocationPiecesJointes");
                });
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.Decision", b =>
                {
                    ...
                    b.Property<decimal>("TotalAbstention")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalContre")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalExprime")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalPour")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ModeleConvocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ModelesConvocation");
                });

            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.OrdreDuJourItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AssembleeGeneraleId", "Ordre")
                        .IsUnique();

                    b.ToTable("OrdreDuJour");
                });

            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.PresenceAss", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("DatePresence")
                        .HasColumnType("datetime2");

                    b.Property<Guid>("LotId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("Tantiemes")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ProcesVerbalVersion", b =>
                {
                    ...
                    b.Property<Guid?>("CommentaireParId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CommentaireSyndic")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("DateScellage")
                        .HasColumnType("datetime2");

                    b.Property<bool>("EstOfficielle")
                        .HasColumnType("bit");

                    b.Property<bool>("EstScelle")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("HashScellage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.Procuration", b =>
                {
                    ...
                    b.HasIndex("AssembleeGeneraleId", "DonneurId")
                        .IsUnique();

                    b.ToTable("Procurations");
                });

            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.RelanceSignatureLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProcesVerbalId", "UserId");

                    b.HasIndex("ProcesVerbalId", "UserId", "DateRelance");

                    b.ToTable("RelanceSignatureLogs", (string)null);
                });

            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.RelanceVoteLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AssembleeGeneraleId", "UserId", "Type")
                        .IsUnique();

                    b.ToTable("RelanceVoteLogs", (string)null);
                });
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.Resolution", b =>
                {
                    ...
                    b.Property<decimal?>("SeuilMajorite")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.SignatureProcesVerbal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProcesVerbalId", "OrdreSignature");

                    b.HasIndex("ProcesVerbalId", "UserId")
                        .IsUnique();

                    b.ToTable("SignatureProcesVerbals", (string)null);
                });
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.Vote", b =>
                {
                    ...
                    b.Property<bool>("EstModifie")
                        .HasColumnType("bit");

                    b.Property<Guid>("LotId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("PoidsVote")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Residences.Residence", b =>
                {
                    ...
                    b.Property<double>("RayonAutoriseMetres")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Residences.ResidencePlanningConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("MaxHeuresParJour")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ResidencePlanningConfigs");
                });
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ConvocationDestinataire", b =>
                {
                    b.HasOne("SyndicApp.Domain.Entities.Assemblees.Convocation", "Convocation")
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.Decision", b =>
                {
                    ...
                    b.HasOne("SyndicApp.Domain.Entities.Assemblees.Resolution", "Resolution")
                        .WithOne("Decision")
                        .HasForeignKey("SyndicApp.Domain.Entities.Assemblees.Decision", "ResolutionId")
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ProcesVerbal", b =>
                {
                    b.HasOne("SyndicApp.Domain.Entities.Assemblees.AssembleeGenerale", "AssembleeGenerale")
                        ...
                        .HasForeignKey("SyndicApp.Domain.Entities.Assemblees.ProcesVerbal", "AssembleeGeneraleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.RelanceSignatureLog", b =>
                {
                    b.HasOne("SyndicApp.Domain.Entities.Assemblees.ProcesVerbal", null)
                        .WithMany("RelancesSignature")
                        .HasForeignKey("ProcesVerbalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SyndicApp.Domain.Entities.Assemblees.ProcesVerbal", b =>
                {
                    b.Navigation("RelancesSignature");
